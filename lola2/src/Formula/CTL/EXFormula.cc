...
*/
EXFormula::EXFormula(Petrinet * n, CTLFormula *phi) : phi(phi)
{
    net = n;
    assert(phi);
}
...
*/
bool EXFormula::check(Store<void *> &s, NetState &ns, Firelist &firelist, Firelist & sfirelist, 
