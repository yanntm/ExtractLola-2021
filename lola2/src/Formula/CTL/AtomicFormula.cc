...
AtomicFormula::AtomicFormula(Petrinet * n)
{
	net = n;
}
...
bool AtomicFormula::check(Store<void *> &, NetState &, Firelist &, Firelist &, std::vector<int> &)
{
