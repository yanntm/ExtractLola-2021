...
\brief Definition of the CTL AF operator.
*/
...
class AFFormula : public DFSFormula
{
public:
    AFFormula(Petrinet *, CTLFormula *psi);
    ...
    std::string ctl2string() { return std::string("AF(") + psi ->ctl2string() + std::string(")");}
