...
public:
    ...
    Mara * memory;
    /// Constructor
    Sweep(Petrinet *, SimpleProperty &property, NetState &ns, SweepEmptyStore &st, Firelist &firelist,
...
private:
    ...
    bool initFront(tpSweepArguments &args, SweepRingStore<T> &store, int &back_progress,
                   int &sem_countdown);
