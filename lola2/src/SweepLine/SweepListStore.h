...
public:
    ...
    SweepListStore(arrayindex_t nr_of_threads , hash_t nr_of_buckets , Petrinet * n, Mara * mem);

    /// constructor for a list of stores of given length
    SweepListStore(arrayindex_t nr_of_threads, hash_t nr_of_buckets, arrayindex_t size, Petrinet * n, Mara * mem);
    ...
    VectorStore<T> *createSweepStore(Petrinet * n, Mara * mem);
