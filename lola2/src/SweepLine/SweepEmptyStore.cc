 ...
 */
SweepEmptyStore::SweepEmptyStore(Petrinet * n, Mara * m) : EmptyStore<void>(n,m,1)
{
}
 ...
 */
void SweepEmptyStore::setMarkings(int count)
{
 ...
 */
void SweepEmptyStore::setCalls(int count)
{
    this->calls[0] = count;
}
