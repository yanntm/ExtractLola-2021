...
public:
    ...
    /// whether formula refers to it
    int visible; // visible iff visible = some formula specific value 

    /// whether the node is member (place) of neighbour (transition) of the max empty siphon
    bool inEmptySiphon;
    ...
    /// if symbol represents a node in a folded skeleton, size is number of LL nodes agglomerated
    int size;
