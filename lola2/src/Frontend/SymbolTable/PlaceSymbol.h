...
public:
    ...
    bool occurspositive; // there exists an atomic proposition where p occurs as positive place (or p is in pre(t) for some UNFIREABLE(t)
    bool occursnegative; // there exists an atomic proposition where p occurs as negative place (or p is in pre(t) for some FIREABLE(t)
