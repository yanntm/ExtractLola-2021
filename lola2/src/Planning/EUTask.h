...
#include <Exploration/EUExploration.h>
...
This class wraps the EU check by statespace exploration

*/

class EUTask : public Task
{
public:
	ternary_t result;
    EUTask(Petrinet *, int,tFormula,int);
    ~EUTask();
    ...
    NetState * ns;
    Firelist * fl;
    EUExploration * exploration;
    StatePredicateProperty * phi;
    StatePredicateProperty * psi;
    Store<void> * store;
    StatePredicate * phiFormula;
    StatePredicate * psiFormula;
