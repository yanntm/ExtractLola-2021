...
void ConjunctionTask::buildTask(Petrinet * n, int par, tFormula f, int fid)
{
	int conj_id = portfoliomanager::addTask(n,NULL,par,fid,FORMULA_CONJUNCTION,CONJUNCTION_TASK,NULL);
	...
	Task::buildTask(n,conj_id,left,-1);
	Task::buildTask(n,conj_id,right,-1);
}
