...
public:
    ...
    explicit NetStateEncoder(Petrinet * n, int _numThreads) : numThreads(_numThreads) {net = n;}
    ...
    virtual unsigned int *encodeNetState(NetState &ns, bitarrayindex_t &bitlen,
