...
public:
    ...
    explicit PrefixTreeStore(Petrinet * n,Mara * mem, threadid_t number_of_threads = 1);
    /// destructor
    ...
    virtual bool searchAndInsert(const capacity_t *in, bitarrayindex_t bitlen, hash_t, T **payload,
