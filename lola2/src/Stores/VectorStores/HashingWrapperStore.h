...
class NullaryVectorStoreCreator : public VectorStoreCreator<P>
{
    ...
    Petrinet * net;
public:
    explicit NullaryVectorStoreCreator(Petrinet * n, Mara * mem)
    {
	memory = mem;
	net = n;
    }
...
class UnaryVectorStoreCreator : public VectorStoreCreator<P>
{
    ...
    Petrinet * net;
public:
    explicit UnaryVectorStoreCreator(Petrinet * n, Mara * mem, A1 _arg1)
    {
        arg1 = _arg1;
	memory = mem;
	net = n;
...
class BinaryVectorStoreCreator : public VectorStoreCreator<P>
{
    ...
    Petrinet * net;
public:
    BinaryVectorStoreCreator(Petrinet * n, Mara * mem, A1 _arg1, A2 _arg2)
    {
        arg1 = _arg1;
        arg2 = _arg2;
	memory = mem;
    ...
    VectorStore<P> *operator() (void) const
    {
        return new T(net,memory, arg1, arg2);
    }
};
...
public:
    ...
    HashingWrapperStore(VectorStoreCreator<T> *_storeCreator, Petrinet * n,Mara * mem,
    ...
    virtual bool searchAndInsert(const capacity_t *in, bitarrayindex_t bitlen, hash_t hash,
                                 T **payload,
    ...
    virtual bool popVector(capacity_t *&out, threadid_t threadIndex = 0);
