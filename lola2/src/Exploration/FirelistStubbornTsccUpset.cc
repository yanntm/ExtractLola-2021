...
FirelistStubbornTsccUpset::FirelistStubbornTsccUpset(Petrinet * n, SimpleProperty *simpleproperty) : Firelist(n),
...
Firelist *FirelistStubbornTsccUpset::createNewFireList(Petrinet * n, SimpleProperty *property)
{
    return new FirelistStubbornTsccUpset(n,property);
}
