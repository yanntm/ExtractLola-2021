...
{
public:
    explicit FirelistStubbornComputeBound(Petrinet *, StatePredicate *);
    ...
    virtual arrayindex_t getFirelist(arrayindex_t,NetState &, arrayindex_t **); // for checking place bound
