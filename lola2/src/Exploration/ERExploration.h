...
public:
    ...
    ERStackEntry(arrayindex_t *f, arrayindex_t c, int * p)
    {
    ...
    ERStackEntry(const ERStackEntry &src)
    {
        current = src.current;
...
public:
	Petrinet * net;
	ERExploration(Petrinet * n):_p(n){net = n;}
    ...
    virtual ~ERExploration() {}
     SearchStack<ERStackEntry> dfsstack;
